...
test -d local-ui5-tgz-plugin || npx cds-add-cucumber-plugin -p local-ui5-tgz -w fiori -f app/fiori-apps.html
...
test -d test/features/bookshop || cp -r ../../../test/features/bookshop test/features
