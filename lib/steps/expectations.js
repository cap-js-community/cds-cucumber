...
* @name When we expect the result to match array ignoring element order
...
* @example When we expect the result to match array ignoring element order
* """
...
/**
* @memberof Expectations
* @name When we expect the result to contain the following details
...
* @example When we expect the result to contain the following details
* """
* {"name": "John Doe"}
* """
*/
...
/**
* @memberof Expectations
* @name When we expect the result to match the saved one
* @description Performs partial deep-match utilizing the previously saved structure with the provided structure
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal"
* @example When we expect the result to match the saved one
* """
* {"name": "John Doe"}
* """
*/
...
/**
* @memberof Expectations
* @name When we expect the result to be {string}
* @description Compares the already extracted information with the provided text
* @example When we expect the result to be "John Doe"
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} to contain the following rows
* @description Extracts the content of the specified table and compares it with the provided structure
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal"
* @example When we expect table {string} to contain the following rows
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} to contain records
...
* @param {object} expected the records to search for
* @example When we expect table "Books" to contain records
* """
...
/**
* @memberof Expectations
* @name When we expect table {string} not to contain records
* @description Extracts the content of the specified table and confirms it does not contain the specified records
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal" when comparing single records.
* @param {string} tableName the name of the target table as displayed in the browser
* @param {object} unexpected the records to search for
* @example When we expect table "Books" not to contain records
* """
* [ {"name": "John Doe"}, {"name": "Richard Roe"} ]
* """
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} to contain record
* @description Extracts the content of the specified table and confirms it contains the specified record
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal" when comparing single records.
* @param {string} tableName the name of the target table as displayed in the browser
* @param {object} expected the record to search for
* @example When we expect table "Books" to contain record
* """
* {"name": "John Doe"}
* """
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} not to contain record
* @description Extracts the content of the specified table and confirms it does not contain the specified record
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal" when comparing single records.
* @param {string} tableName the name of the target table as displayed in the browser
* @param {object} unexpected the record to search for
* @example When we expect table "Books" not to contain record
* """
* {"name": "John Doe"}
* """
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} to have {int} records
...
* @example When we expect table {string} to have {int} records
*/
...
/**
* @memberof Expectations
* @name When we expect table {string} to have {int} records in total
* @description Confirms the total record count of the specified table
* @param {string} tableName the name of the target table as displayed in the browser
* @param {int} expectedRowCount expected count of rows in the table
* @example When we expect table {string} to have {int} records in total
*/
...
/**
* @memberof Expectations
* @name When we expect to have {int} table records
...
* @example When we expect to have {int} table records
*/
...
/**
* @memberof Expectations
* @name When we expect field {string} to be {string}
...
* @example When we expect field "Title" to be "The Raven"
*/
