...
*    by utilizing the function shallowDeepEqual of the nodejs module "chai-shallow-deep-equal"
* @example When we expect table "Books" to contain the following rows
* """
...
* @example When we expect table "Books" to have 100 records
*/
...
* @param {string} tableName the name of the target table as displayed in the browser
* @param {int} expectedRowCount expected count of rows in the table
* @example When we expect table "Books" to have 4000 records in total
*/
...
* @example When we expect to have 500 table records
*/
