...
* @description Changes the value of specified field to the provided one.
  Works also for filter fields with ValueHelp where the value will be selected in the ValueHelp dialog.
* @param {string} field name of the target field
* @param {string} text the new value of the field
...
* @description Changes the current prompt (active dialog) the the specified value
...
* @example When we enter in the prompt {string}
*/
