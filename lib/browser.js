class CDS {
  ...
  modifyField(fieldLabel, newText) {
    ...
    if(field.getMetadata().getName()=='sap.ui.layout.form.FormElement') {
      this.openValueHelpDialogForField(fieldLabel);
      return false;
    }
    if(field.getMetadata().getName()=='sap.ui.mdc.FilterField') {
      this.openValueHelpDialogForFilterField(fieldLabel);
      return false;
    }
  ...
  selectItemInValueHelpPopup(fieldName,text) {
    ...
    let fieldFieldValueHelpId = currentContent[0]._getValueHelpIcon().getId();
    ...
    popoverFieldValueHelpId = popoverFieldValueHelpId.replace('::FilterFieldValueHelp::','::FilterField::')
  ...
  _selectRowInValueHelpDialog(rowIndex) {
    ...
    if(table.getSelectionMode()=='Single') {
